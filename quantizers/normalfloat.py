...
NF4 shape with a PER-BLOCK absmax scale, block size 64 by default. NF3 uses an
8-level shape generated by equal-mass normal-quantile binning.

The level shape is provided as a normalised 1-D tensor (max|q| = 1); the
block-wise assignment lives in BaseQuantizer.quantize.
"""
